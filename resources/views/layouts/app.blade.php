...
<head>
    ...
    <title>@yield('title') - PS Cash</title>
...
<body>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2" style="text-transform: capitalize;">PS Cash</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->routeIs('transaksi.masuk') || request()->routeIs('transaksi.masuk.*') ? 'active' : '' }}">
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                ...
                                , made with ❤️ by
                                <a href="https://wokaproject.id" target="_blank" class="footer-link fw-bolder">Woka Project Mandiri</a>
                            </div>
                            <!-- <div>
    ...
    <!-- Script tambahan setiap halaman -->
    @stack('scripts')
